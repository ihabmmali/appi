...
class KodiControllerSmokeTests(unittest.TestCase):
    def test_browse_paging_context_and_hls_configuration_paths(self):
        code = r'''
...
settings = {
    'movie_sort':'4','tv_sort':'4','page_size':'25',
...
movies=[{'kind':'movie','display_title':'Movie %03d (2025)'%i,'title':'Movie %03d'%i,'year':2025,'tvg_id':'tt%03d'%i,'media_url':'https://x/%d'%i} for i in range(30)]
